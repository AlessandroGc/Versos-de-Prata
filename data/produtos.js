/**
 * VERSOS DE PRATA — Catálogo de Produtos
 * =======================================
 * Para adicionar um produto novo, basta copiar um bloco
 * abaixo e preencher os campos. O site se atualiza automaticamente.
 *
 * Campos obrigatórios: id, nome, preco, categoria, imagens[0], descricao
 * Campo opcional: tamanho = { enabled: true|false, options: [] }
 * Categorias válidas: "anel" | "pulseira" | "colar" | "brinco" | "conjunto"
 */
...
window.PRODUTOS = [
  ...
  ======================== */
  {
    id: "anel-ponto-de-luz-coracao-azul",
  ...
  {
    id: "anel-solitario-curvado-zirconia",
    nome: "Anel de Prata 925 Solitário Curvado Zircônia Central",
    preco: 84.90,
    categoria: "anel",
    destaque: true,
    estoque: 1,
  ...
  ======================== */
  {
    id: "conjunto-ponto-de-luz-grande-branco",
    nome: "Conjunto de Prata 925 Ponto de Luz Grande Branco",
    preco: 139.90,
    categoria: "conjunto",
    destaque: false,
    estoque: 1,
